                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Text("publié par : ", style: GoogleFonts.poppins( textStyle: TextStyle(color: black.withOpacity(0.3),fontSize: 12,letterSpacing: 0.5, decoration: TextDecoration.none)),),
